...
public class Chicken extends Bird {
	...
	public Chicken(int age, String gender, float weight, int eggsPerYear) {
	...
	public void seteggsPerYear(int eggsPerYear) {
		if(eggsPerYear >= 0 && eggsPerYear < 400) {
	...
	public boolean equals(Object other) {
		...
		if((other == null) || (this.getClass() != other.getClass())){
			...
			Chicken otherChicken = (Chicken)other;

			//using a ternary operator, verify that only the animal types are equal
			result = this.type.equals(otherChicken.type) ? true : false;
